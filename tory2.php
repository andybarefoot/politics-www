...
<div id="main" class="clearfix">
	...
	<div id="content">
	<img src="http://www.andybarefoot.com/politics/posterTory2.php?textPos=<? print $stextPosition; ?>&colour=<? print $scolour; ?>&photo=<? print $sphoto; ?>&userImg=<? print $userPhoto; ?>&line1=<? print $sline1; ?>&line2=<? print $sline2; ?>&logo1=<? print $slogo1; ?>&logo2=<? print $slogo2; ?>&logo3=<? print $slogo3; ?>&tagline1=<? print $stagline1; ?>&size=<? print $size; ?>" alt="David Cameron poster">
	<h3>
<?
if(($poster)&&($photo!=4)){
?>
...
?>
	...
	<form name="posterForm" action="tory2.php" method="POST" enctype="multipart/form-data">
	<table>
	<tr>
