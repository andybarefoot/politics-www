...
if($_GET['poster']){
	...
	if($_POST['line1']){
		...
		$line1="Now Gordon wants $20,000 when you die.";
	}
	if($_POST['line2']){
		...
		$line2="Don't vote for Labour's new death tax.";
	}
	if($_POST['logo1']){
...
<html>
	<head>
		...
		<title>Make your own Conservative tombstone poster</title>
	</head>
	<style>
/*  
